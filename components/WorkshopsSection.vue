  ...
  data() {
    return {
      workshops: [
        ...
        {
          name: "Hackathon 101",
          about: 'Never participated in a hackathon? Don\'t worry. HackOn brings to you Hackathon 101 by Jatin Katyal, the absolute champion of hackathons!',
          date: "11/04/2020",
          time: "4:00 PM",
          speaker: {
            name: "Jatin Katyal",
            designation: "Software Engineer, Coding Blocks",
            about: 'Jatin is a full-stack web developer, who has won numerous hackathons, and is extremely passionate about them.',
            picture:
        ...
        },
        {
          ...
          speaker: {
            ...
            about: ' Arnav is a Co-Founder at Coding Blocks and was an Android Lead at Zomato.',
            picture:
